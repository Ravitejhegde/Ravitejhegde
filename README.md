...
🔹 [Expense Tracker App](https://github.com/YOUR_GITHUB_USERNAME/expense-tracker) – Manage daily expenses with charts & insights.  
🔹 [Train Search Web App](https://github.com/YOUR_GITHUB_USERNAME/train-search) – Search trains using Indian Rail API.  
🔹 [Social Media Prototype](https://github.com/YOUR_GITHUB_USERNAME/social-media) – Instagram-like app built with Angular & Firebase.  
